  ...
  return (
    <div className="p-4">
      <button 
        ...
        aria-label={i18n.language === "ar" ? "Switch to English" : "التغيير إلى العربية"}
      >
        {i18n.language === "en" ? (
          <img
